  ...
  <AppBar position="static">
    <Toolbar>
      ...
      <div>
        ...
        <Link to="/shops/all">
          <Button style={isActive(history, "/shops/all")}>FON Shops</Button>
        </Link>
        <Link to="/auctions/all">
          <Button style={isActive(history, "/auctions/all")}>FON Tender</Button>
        </Link>
        <Link to="/cart">
      ...
      }
      {
        auth.isAuthenticated() && (<span>
          {auth.isAuthenticated().user.seller && (<>
            ...
            <Link to="/myauctions"><Button style={isPartActive(history, "/myauctions")}>My Bids</Button></Link>
            </>
          )}
